...
class JoystickCalibratorUI:
    ...
    def draw_joystick_position(self, x, y, size):
        ...
        pos_x = x + int(steering * size//2 * 0.95)  # 0.95 to avoid touching the edge
        ...
        # Point representing current position (larger and more visible)
    ...
    def draw_interface(self, elapsed_time):
        """Draw the complete calibration interface with an enhanced style."""
        # Gradient background
